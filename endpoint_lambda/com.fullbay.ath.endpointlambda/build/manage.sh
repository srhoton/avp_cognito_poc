...
FUNCTION_NAME=QuarkusApplication
HANDLER=io.quarkus.amazon.lambda.runtime.QuarkusStreamHandler::handleRequest
RUNTIME=java${JAVA_MAJOR_VERSION_NUM}
ZIP_FILE=fileb:///Users/steverhoton/git/avp_cognito_poc/endpoint_lambda/com.fullbay.ath.endpointlambda/build/function.zip
...
then
  ...
  ZIP_FILE=fileb:///Users/steverhoton/git/avp_cognito_poc/endpoint_lambda/com.fullbay.ath.endpointlambda/build/function.zip
  FUNCTION_NAME=QuarkusApplicationNative
