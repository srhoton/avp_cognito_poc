...
FUNCTION_NAME=ComFullbayAthUserauthorizer
HANDLER=io.quarkus.amazon.lambda.runtime.QuarkusStreamHandler::handleRequest
RUNTIME=java${JAVA_MAJOR_VERSION_NUM}
ZIP_FILE=fileb:///Users/steverhoton/git/avp_cognito_poc/user_authorizer/com.fullbay.ath.userauthorizer/target/function.zip
...
then
  ...
  ZIP_FILE=fileb:///Users/steverhoton/git/avp_cognito_poc/user_authorizer/com.fullbay.ath.userauthorizer/target/function.zip
  FUNCTION_NAME=ComFullbayAthUserauthorizerNative
